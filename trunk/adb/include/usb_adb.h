...
typedef struct
{
	...
	// STM32 use one channel per address/endpoint/direction
	uint8_t stm32_in_chan_num;
	uint8_t stm32_out_chan_num;
...
#define USB_NAK_LIMIT       320 /*32000*/   // NAK limit for a transfer. o meand NAKs are not counted
