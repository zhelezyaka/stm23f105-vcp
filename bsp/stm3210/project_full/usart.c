...
#define UART4_DR_Base   0x40004c00
...
static void GPIO_Configuration(void)
{
	...
	//RCC->CFGR |= (uint32_t)RCC_CFGR_MCO_PLLCLK_Div2;
...
void rt_hw_usart_init()
{
	...
	USART_InitStructure.USART_HardwareFlowControl = USART_HardwareFlowControl_None;
	USART_InitStructure.USART_Mode = USART_Mode_Rx | USART_Mode_Tx;
	/* NA for 105 */ //USART_ClockInitStructure.USART_Clock = USART_Clock_Disable;
	/* NA for 105 */ //USART_ClockInitStructure.USART_CPOL = USART_CPOL_Low;
	/* NA for 105 */ //USART_ClockInitStructure.USART_CPHA = USART_CPHA_2Edge;
	/* NA for 105 */ //USART_ClockInitStructure.USART_LastBit = USART_LastBit_Disable;
	USART_Init(UART4, &USART_InitStructure);
	/* NA for 105 */ //USART_ClockInit(UART4, &USART_ClockInitStructure);
