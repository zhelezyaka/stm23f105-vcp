...
void rt_hw_led_toggle(rt_uint32_t n)
{
    ...
    {
    case 0:
        GPIO_ReadOutputDataBit(led1_gpio, led1_pin)?GPIO_ResetBits(led1_gpio, led1_pin):GPIO_SetBits(led1_gpio, led1_pin);
        break;
    case 1:
        GPIO_ReadOutputDataBit(led2_gpio, led2_pin)?GPIO_ResetBits(led2_gpio, led2_pin):GPIO_SetBits(led2_gpio, led2_pin);
        break;
    default:
        break;
    }
